...
public class HiveDbContext : DbContextBase
{
    ...
    static readonly IReadOnlyDictionary<string, object> kDefaultGlobalSettings = new Dictionary<string, object>()
    {
        ...
        { ConfigNames.FtpPassiveAddress, "" },
        { ConfigNames.FtpPassivePortMin, 0 },
        { ConfigNames.FtpPassivePortMax, 0 },
        ...
        { ConfigNames.ServiceInternetArchiveWorker, true },
        { ConfigNames.ServiceInternetArchiveWorkerUrl, "https://archive.foxcouncil.com" },
        ...
        { ConfigNames.ServiceFtp, true },
        { ConfigNames.ServiceTelnet, true },
        { ConfigNames.ServiceSocks, true },
        { ConfigNames.ServiceOscar, true },
        ...
        { ConfigNames.IrcRequireAuthentication, false },
        { ConfigNames.IrcMotd, "" },
        { ConfigNames.IrcHostname, "" },
        { ConfigNames.IrcVersion, "" },
